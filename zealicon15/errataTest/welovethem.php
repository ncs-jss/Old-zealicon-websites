...
<head>
	...
	<body>
	<div class="header">
		<div class="imgt"><img src="img/z_blood.png" style="max-width:200px;max-height:200px;"/></div><div class="hdng">ERRATA - The Treasure Hunt</div>
	</div>
						...
						<?php
							...
							class que
							{
								public function get($con)
								{
										...
										$sql="SELECT * FROM `list` WHERE `level` = '18'";
